...
function resetEduButtons(select) {
    if(theme == 0) {
        ...
        if(select != 0) document.getElementById("explorin-btn").style.backgroundColor = "#a5ffa6c7";
        if(select != 1) document.getElementById("shivalik-btn").style.backgroundColor = "#a5ffa6c7";
        if(select != 2) document.getElementById("sunrise-btn").style.backgroundColor = "#a5ffa6c7";
    }
}
...
function explorinClick() {
    ...
    if(theme == 0) {
        ...
        document.getElementById("explorin-btn").style.backgroundColor = "#1bb809e4";
...
function shivalikClick() {
    ...
    if(theme == 0) {
        ...
        document.getElementById("shivalik-btn").style.backgroundColor = "#1bb809e4";
...
function sunriseClick() {
    ...
    if(theme == 0) {
        ...
        document.getElementById("sunrise-btn").style.backgroundColor = "#1bb809e4";
